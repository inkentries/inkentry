...
| The checker itself actually rejects things | `crates/spelunk-cli/tests/schema_contract_checker.rs`. Without it, a checker that accepted everything would leave every golden file green. |
