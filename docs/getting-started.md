...
<!-- pending Johan decision + #325 — the Homebrew tap is not yet published; the
     release workflow ships tarballs only. The tap name shown above is an
     unconfirmed guess from org naming convention, not canonical. -->
...
<!-- pending Johan decision + #325 — install.sh is not yet generated by the
     release pipeline. The canonical URL is TBD. -->
...
<!-- pending Johan decision + #325 — the release workflow currently produces
     only .tar.gz artifacts. .deb packaging and the artifact name are TBD. -->
