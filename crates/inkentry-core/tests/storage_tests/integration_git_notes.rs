...
async fn supersede_edge_lands_on_old_record_not_new() {
    ...
    let new_entity_id = inkentry_core::storage::note_entity_id(&new);
    let old_entity_id = inkentry_core::storage::note_entity_id(&old);
...
async fn racing_supersedes_of_the_same_old_both_land_conflicting_state_updates() {
    ...
    let entity_id_a = inkentry_core::storage::note_entity_id(&successor_a);
    let entity_id_b = inkentry_core::storage::note_entity_id(&successor_b);
    ...
    let blob = read_raw_note(root);
    let old_entity_id =
        inkentry_core::storage::entity_id("decision", "decision OLD", "body for decision OLD");
