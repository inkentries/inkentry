...
impl EmbedderSlot {
    ...
    pub fn ready(backend: Arc<dyn inkentry_core::embeddings::EmbeddingBackend>) -> Self {
        Self(Arc::new(RwLock::new(EmbedderSlotInner {
    ...
    pub fn set_ready(&self, backend: Arc<dyn inkentry_core::embeddings::EmbeddingBackend>) {
    ...
    pub fn backend(&self) -> Option<Arc<dyn inkentry_core::embeddings::EmbeddingBackend>> {
        self.0
            .read()
            .expect("embedder slot poisoned")
            .backend
