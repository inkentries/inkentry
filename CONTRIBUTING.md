# Contributing to inkentry

Thanks for your interest in contributing. inkentry is a local-first code
...
## Working on inkentry with an AI agent

This repository is itself indexed with inkentry, and [CLAUDE.md](CLAUDE.md)
documents the agent workflow (search before reading, store decisions in
`inkentry memory`). If you contribute using a coding agent, pointing it at
...
inkentry is [MIT](LICENSE) licensed. By contributing, you agree that your
